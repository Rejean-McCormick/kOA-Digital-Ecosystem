...
See: `docs/2-Technical-Reference/40-integration/kristal-v4/` (especially `pinned-dependency.md` and `contract-pointers.md`). This is the single place in the kOA docs that points to the pinned Kristal v4 source-of-truth.
...
- For **kOA-native artifacts**, validate against schemas in `docs/2-Technical-Reference/30-artifacts/schemas/`.
- For **Kristal artifacts**, validate against the pinned Kristal v4 schemas referenced in `docs/2-Technical-Reference/40-integration/kristal-v4/contract-pointers.md`.
...
- `docs/2-Technical-Reference/00-overview/system-at-a-glance.md`
- `docs/2-Technical-Reference/10-system/architecture.md`
- `docs/2-Technical-Reference/60-guides/implementers.md`
...
- `docs/2-Technical-Reference/50-operations/incident-response.md`

## How do changes get made safely?
- Changes to **kOA** invariants/interfaces: add/update an ADR under `docs/2-Technical-Reference/90-reference/adr/`.
...
- `docs/2-Technical-Reference/40-integration/kristal-v4/koa-profile.md` (policy/constraints)
- `docs/2-Technical-Reference/40-integration/kristal-v4/conformance.md` (tests/acceptance)
